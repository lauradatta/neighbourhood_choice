...
#load SPSS files
mutatie18_sav <- read_sav("input/Bevolkingsmutaties 2018 - 2.sav")
gba18_sav <- read_sav("input/Gba19.sav")
vhb1418_door_sav <- read_sav("input/Vhb14-18 doorstromers woningen.sav")
vhb1418_in_sav <- read_sav("input/Vhb14-18 inverhuizingen woningen.sav")
vhb1418_uit_sav <- read_sav("input/Vhb14-18 uitverhuizingen woningen.sav")
# loading from SPSS didn't work so was transformed into csv
woningen18 <- read_csv2("input/Wkt2019 woningen.csv")
